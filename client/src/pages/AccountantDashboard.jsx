            ...
            <Section title="Alerts & Action Items" icon={AlertTriangle}>
              <div style={{ display: 'grid', gap: 10 }}>
                {pendingRequests.length > 0 && (
                  <AlertCard icon={ShieldAlert} color="var(--warning)" bg='var(--warning)'
                ...
                {overdueVendors.length > 0 && (
                  <AlertCard icon={AlertTriangle} color="var(--error)" bg='var(--destructive)'
                ...
                {dueEmis.length > 0 && (
                  <AlertCard icon={Banknote} color="var(--accent)" bg='var(--primary)'
                ...
                {dueKuris.length > 0 && (
                  <AlertCard icon={CircleDollarSign} color="var(--warning)" bg='var(--muted-foreground)'
                ...
                {overdueUtilities.length > 0 && (
                  <AlertCard icon={AlertCircle} color="var(--warning)" bg='var(--warning)'
                ...
                {unpaidRents.length > 0 && (
                  <AlertCard icon={Building2} color='var(--success)' bg='var(--success)'
              ...
              <Section title={`Branch Details — ${monthLabel(month)}`} icon={Building2}>
                ...
                <div className="acc-branch-grid">
                  {expDash.branch_expenses.map((b, i) => {
                    const branchColors = ['var(--accent)', 'var(--accent)', 'var(--success)', 'var(--warning)', 'var(--error)'];
