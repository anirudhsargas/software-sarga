              ...
              <form onSubmit={!editing ? handleReview : submitForm}>
                <div className="em-modal__body">
                  <div className="em-form-grid">
                    <div className="em-form-group"><label>Category</label><select className="em-input" value={form.expense_category} onChange={e => setForm(p => ({ ...p, expense_category: e.target.value }))} required><option value="">Select Category</option>{MISC_CATEGORIES.map(c => <option key={c}>{c}</option>)}</select></div>
                    ...
                    <div className="em-form-group"><label>Recurring?</label><select className="em-input" value={form.is_recurring ? 'true' : 'false'} onChange={e => setForm(p => ({ ...p, is_recurring: e.target.value === 'true' }))}><option value="false">No</option><option value="true">Yes</option></select></div>
