                                        ...
                                        <div className="row gap-sm">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <input
                                                    ...
                                                    placeholder="AUTOGENERATED"
                                                    disabled={!(role === 'Admin' && (Number(selectedItem.quantity) || 0) === 0)}
                                                />
                                                {role === 'Admin' && (Number(selectedItem.quantity) || 0) === 0 ? (
                                                    <small style={{ color: 'var(--text-muted)', fontSize: '10px', marginTop: '2px', display: 'block' }}>Only editable when stock is 0</small>
                                                ) : (
                                                    <small style={{ color: 'var(--text-muted)', fontSize: '10px', marginTop: '2px', display: 'block' }}>SKU cannot be changed after creation</small>
                                                )}
                                            </div>
                                        </div>
