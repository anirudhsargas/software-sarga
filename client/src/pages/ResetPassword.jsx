...
export default function ResetPassword() {
        ...
        return (
            <div style={containerStyle}>
                <div style={{ ...cardStyle, textAlign: 'center' }}>
                    ...
                    <h2 style={{ margin: '0 0 8px', color: '#111' }}>Invalid or Expired Link</h2>
                    <p style={{ color: '#6b7280' }}>This password reset link is invalid or has expired. Please request a new one.</p>
                    <Link to="/forgot-password" style={{ color: '#6366f1', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 4, marginTop: 16 }}>
                        Request New Link
                    </Link>
                </div>
            </div>
        ...
        return (
            <div style={containerStyle}>
                <div style={{ ...cardStyle, textAlign: 'center' }}>
                    ...
                    <p style={{ color: '#6b7280' }}>Your password has been successfully reset. You can now login with your new password.</p>
    ...
    return (
        <div style={containerStyle}>
            <div style={cardStyle}>
                <h2 style={{ margin: '0 0 8px', color: '#111', textAlign: 'center' }}>Reset Password</h2>
                <p style={{ color: '#6b7280', textAlign: 'center', marginBottom: 24 }}>Enter your new password below.</p>
                <form onSubmit={handleSubmit}>
                    ...
                    <div style={{ marginBottom: 16 }}>
                        <label style={{ fontSize: 14, fontWeight: 600, display: 'block', marginBottom: 6, color: '#374151' }}>Confirm Password</label>
                        <div style={{ position: 'relative' }}>
                            <Lock size={18} style={{ position: 'absolute', left: 12, top: '50%', transform: 'translateY(-50%)', color: '#9ca3af' }} />
                    ...
                    {error && <div style={{ color: '#ef4444', fontSize: 14, marginBottom: 12, textAlign: 'center' }}>{error}</div>}
                ...
                <div style={{ textAlign: 'center', marginTop: 20 }}>
                    <Link to="/login" style={{ color: '#6366f1', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 4 }}>
