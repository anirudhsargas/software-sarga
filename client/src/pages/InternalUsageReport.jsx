...
const DEPT_COLOR = { offset: 'var(--accent)', digital: 'var(--accent)', admin: 'var(--success)' };
        ...
        <PageContainer>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 14, marginBottom: 24 }}>
                ...
                {Object.entries(summary).map(([dept, data]) => (
                    <div key={dept} className="panel" style={{ display: 'flex', flexDirection: 'column', gap: 6, borderLeft: `3px solid ${DEPT_COLOR[dept] || 'var(--accent)'}` }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 12, fontWeight: 600, color: DEPT_COLOR[dept] || 'var(--accent)' }}>
                            <Building2 size={13} />
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    style={{
                                                        width: 14,
                                                        height: h,
                                                        background: DEPT_COLOR[dept] || 'var(--accent)',
                                                        borderRadius: 3,
                                                        opacity: 0.85,
                                                    }}
                                                />
